...
void PopulateVectorProducts(inout ShadingProperties props)
{
    ...
    props.wGeometricNormal = normalize(fsIn.wNormal);
    mat3 tangentToWorldMat = CreateTangentToWorldMatrix(props.wGeometricNormal, props.t, fsIn.wTangent.w);
